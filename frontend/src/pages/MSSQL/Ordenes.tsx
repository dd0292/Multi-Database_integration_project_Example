...
const MSSQLOrdenes = () => {
  ...
  const createMutation = useMutation({
    mutationFn: async (data: any) => {
      return api.post("/mssql/ordenes", data);
    },
    onSuccess: () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-mssql">MS SQL Órdenes</h1>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-4">
              {data.data.map((orden) => (
                <Card key={orden.OrdenId} className="p-5">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <h3 className="font-semibold text-lg">Order #{orden.OrdenId}</h3>
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-mssql">
